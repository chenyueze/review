/*************************************************************************
	...
	> Author: 
	> Mail: 
	> Created Time: 2020年06月04日 星期四 19时50分31秒
 ************************************************************************/
...
#include "../common/show_stop.h"
#include "../common/show_carry.h"
...
int main(int argc, char **argv) {
    ...
    */
    ...
    if (argc != 6) {
        fprintf(stderr, "Usage %s -ip - port -name -team -msg", argv[0]);
        exit(1);
    }
    strcpy(server_ip, argv[1]);
    server_port = atoi(argv[2]);
    strcpy(request.name, argv[3]);
    request.team = atoi(argv[4]);
    strcpy(request.msg, argv[5]);
